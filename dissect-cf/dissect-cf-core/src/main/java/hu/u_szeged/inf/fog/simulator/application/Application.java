...
public class Application extends Timed {
    ...
    public void tick(long fires) {
        ...
        if (unprocessedData > 0) {
            ...
            while (unprocessedData != alreadyProcessedData) {
                ...
                if (vml == null) {
                    ...
                    System.out
                        .print(this.name + " data/VM: " + ratio + " unprocessed after exit: " + unprocessedData + " decision:");
        ...
        System.out.println(this.currentTask == 0 );
        System.out.println(this.incomingData == 0);
        System.out.println(this.sumOfProcessedData == this.sumOfArrivedData);
        System.out.println(this.sumOfProcessedData);
        System.out.println(this.sumOfArrivedData);
        System.out.println(this.checkDeviceState());
