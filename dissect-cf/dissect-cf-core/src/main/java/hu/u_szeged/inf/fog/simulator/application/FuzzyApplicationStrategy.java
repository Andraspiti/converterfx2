   ...
   public void install() {
      ...
      if (caList.size() > 0) {
         ...
         for (int i = 0; i < caList.size(); i++) {
            ...
            System.out.println(ca.name + " Load Resource " + ca.getLoadOfResource() + " Price: " + ca.applicationList.get(0).instance.pricePerTick * 100000000 + " UnprocessedData: " + (ca.applicationList.get(0).sumOfArrivedData - ca.applicationList.get(0).sumOfProcessedData) / ca.applicationList.get(0).taskSize);
            ...
            System.out.println(ca.applicationList.get(0).instance.pricePerTick * 100000000);
