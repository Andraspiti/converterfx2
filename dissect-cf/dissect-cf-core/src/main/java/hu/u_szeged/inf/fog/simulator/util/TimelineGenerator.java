...
public abstract class TimelineGenerator {
	 ...
	 */
	public static File generate(String path) throws FileNotFoundException, UnsupportedEncodingException {
		Calendar cal = Calendar.getInstance();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss");
		String filename = sdf.format(cal.getTime())+"-Timeline.html";
		String filepath = path == null ? filename : String.join("/", path, filename);
